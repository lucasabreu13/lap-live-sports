...
export function SportDataMatrix() {
  ...
  return (
    <section className="data-matrix" aria-labelledby="data-matrix-title">
      <div className="data-matrix__hero">
      ...
      <div className="data-matrix__grid">
        {blueprints.map((blueprint) => {
          const sport = sportMeta(blueprint.sportId);
          return (
            <article className="data-matrix-card" key={blueprint.sportId}>
              <header>
